...
// Save the instance
b.data(a,i,this)}var h=a.document,i="__pz__",j=Array.prototype.slice,k=function(){var a=h.createElement("input");return a.setAttribute("oninput","return"),"function"==typeof a.oninput}(),l=/([A-Z])/g,m=/^http:[\w\.\/]+svg$/,n=/^inline/,o="(\\-?[\\d\\.e]+)",p="\\,?\\s*",q=new RegExp("^matrix\\("+o+p+o+p+o+p+o+p+o+p+o+"\\)$");/**
...
// Update range
c.range&&this.$zoomRange.val(o),this.options.disableXAxis||this.options.disableYAxis){var r=this.getMatrix(this.getTransform());this.options.disableXAxis&&(a[4]=r[4]),this.options.disableYAxis&&(a[5]=r[5])}return this.setTransform("matrix("+a.join(",")+")"),c.silent||this._trigger("change",a),a}},/**
