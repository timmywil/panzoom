...
this.isSVG=m.test(a.namespaceURI)&&"svg"!==a.nodeName.toLowerCase(),this.panning=!1,
...
// De-camelcase
this._transform=!this.isSVG&&b.cssProps.transform.replace(l,"-$1").toLowerCase(),
...
inverse:function(){var a=1/this.determinant(),b=this.elements;return new e(a*(b[8]*b[4]-b[7]*b[5]),a*-(b[8]*b[1]-b[7]*b[2]),a*(b[5]*b[1]-b[4]*b[2]),a*-(b[8]*b[3]-b[6]*b[5]),a*(b[8]*b[0]-b[6]*b[2]),a*-(b[5]*b[0]-b[3]*b[2]),a*(b[7]*b[3]-b[6]*b[4]),a*-(b[7]*b[0]-b[6]*b[1]),a*(b[4]*b[0]-b[3]*b[1]))},/**
		 ...
		 * @returns {Number}
		 */
determinant:function(){var a=this.elements;return a[0]*(a[8]*a[4]-a[7]*a[5])-a[3]*(a[8]*a[1]-a[7]*a[2])+a[6]*(a[5]*a[1]-a[4]*a[2])}},f.prototype.e=e.prototype.e=function(a){return this.elements[a]},g.rmatrix=q,g.defaults={
...
return a?this.setTransform(a):a=b[this.isSVG?"attr":"style"](d,"transform"),"none"===a||q.test(a)||this.setTransform(a=b.css(d,"transform")),a||"none"},/**
		 * Retrieve the current transform matrix for $elem (or turn a transform into it's array values)
		 * @param {String} [transform] matrix-formatted transform value
		 * @returns {Array} Returns the current transform matrix split up into it's parts, or a default matrix
		 */
getMatrix:function(a){var b=q.exec(a||this.getTransform());return b&&b.shift(),b||[1,0,0,1,0,0]},/**
...
// Convert to array
"string"==typeof a&&(a=this.getMatrix(a));var d,e,f,g,h,i,j,k,l,m,o=+a[0],p=this.$parent,q="undefined"!=typeof c.contain?c.contain:this.options.contain;
// Set the matrix on this.$set
if(
// Apply containment
q&&(d=this._checkDims(),e=this.container,l=d.width+d.widthBorder,m=d.height+d.heightBorder,f=(l*Math.abs(o)-e.width)/2,g=(m*Math.abs(o)-e.height)/2,j=d.left+d.margin.left,k=d.top+d.margin.top,"invert"===q?(h=l-e.width,i=m-e.height,f+=(e.width-l)/2,g+=(e.height-m)/2,a[4]=Math.max(Math.min(a[4],f-j),-f-j-h),a[5]=Math.max(Math.min(a[5],g-k),-g-k-i+d.heightBorder)):(f+=d.widthBorder/2,g+=d.heightBorder/2,h=e.width>l?e.width-l:0,i=e.height>m?e.height-m:0,"center"===p.css("textAlign")&&n.test(b.css(this.elem,"display"))?h=0:f=g=0,a[4]=Math.min(Math.max(a[4],f-j),-f-j+h),a[5]=Math.min(Math.max(a[5],g-k),-g-k+i))),"skip"!==c.animate&&
// Set transition
...
step:c.rangeStep===g.defaults.rangeStep&&j.attr("step")||c.rangeStep,min:c.minScale,max:c.maxScale}).prop({value:this.getMatrix()[0]}),!c.disableZoom){var l=this.$zoomIn,m=this.$zoomOut;
// Bind zoom in/out
// Don't bind one without the other
l.length&&m.length&&(
// preventDefault cancels future mouse events on touch events
l.on(f,function(b){b.preventDefault(),a.zoom()}),m.on(f,function(b){b.preventDefault(),a.zoom(!0)})),j.length&&(h={},h["mousedown"+d]=function(){a.transition(!0)},h[(k?"input":"change")+d]=function(){a.zoom(+this.value,{noSetRange:!0})},j.on(h))}},/**
		 * Unbind all events
		 */
